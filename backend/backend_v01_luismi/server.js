...
const { listReservas, getReserva, newReserva, editReserva, deleteReserva } = require('./controllers/reservas');
...
app.delete('/hoteles/:id/photos/:photosId', isUser, hotelExists, canEdit, deleteHotelPhoto);
...
app.put('/espacios/:id', isUser, canEdit, editEspacio);

// DELETE - /espacios/:id
// borra un espacios en la BBDD
app.delete('/espacios/:id', isUser, canEdit, deleteEspacio);

// POST - /espacios/:id/photo (token)
// Añade una foto a un espacio
app.post('/hoteles/:id/espacios/:idEspacio/fotos', isUser, canEdit, addEspacioPhoto);

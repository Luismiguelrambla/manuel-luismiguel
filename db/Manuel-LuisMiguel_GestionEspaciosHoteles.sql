...
CREATE TABLE `calificacion` (
  ...
  UNIQUE KEY `reservan_IdUsers_IdEspacios_uq1` (`IdUsers`,`IdEspacios`),
  KEY `calificacion_IdEspacios_fk2` (`IdEspacios`),
...
CREATE TABLE `equipamiento` (
  ...
  `pantallaProyector` tinyint(1) DEFAULT '0',
  `television` tinyint(1) DEFAULT '0',
  `climatizacion` tinyint(1) DEFAULT '0',
  `equipoSonido` tinyint(1) DEFAULT '0',
...
CREATE TABLE `reservan` (
  ...
  `precioReserva` decimal(5,2) DEFAULT '0.00',
  PRIMARY KEY (`IdReserva`),
  UNIQUE KEY `reservan_IdEspacios_fechaLlegada_uq1` (`IdEspacios`,`fechaLlegada`),
...
-- Dump completed on 2020-12-22 12:53:26

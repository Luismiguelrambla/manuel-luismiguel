...
const newUser = async (req, res, next) => {
    ...
    try {
        ...
        `
        INSERT INTO usuarios(fechaRegistro, nombre, apellidos, correo, contraseña, registrationCode)
        VALUES(?,?,SHA2(?, 512),?) 
        `,
        [new Date(), nombre, apellidos, email, password, registrationCode]
        );
